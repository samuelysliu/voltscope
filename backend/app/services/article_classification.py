...
TOPIC_RULES = {
    ...
    "charging-station": ("charging station", "fast charger", "supercharger", "charging network", "infrastructure", "\u5145\u96fb\u7ad9", "\u5145\u96fb\u6a01"),
    "charging": ("charging", "charger", "battery", "range", "kwh", "cell", "\u5145\u96fb", "\u96fb\u6c60", "\u7e8c\u822a"),
    "smart-mobility": ("autonomous", "robotaxi", "self-driving", "driverless", "mobility", "lidar", "fleet", "\u81ea\u99d5", "\u7121\u4eba\u99d5\u99db", "\u667a\u6167\u79fb\u52d5"),
...
TAG_RULES = {
    ...
    "charging-deals": ("discount", "rebate", "incentive", "coupon", "financing", "0% interest", "\u512a\u60e0", "\u6298\u6263"),
    "charging-station": ("charging station", "fast charger", "supercharger", "charging network", "\u5145\u96fb\u7ad9", "\u5145\u96fb\u6a01"),
    "ev": ("electric vehicle", "electric car", " ev ", "tesla", "ford", "rivian", "lucid", "\u96fb\u52d5\u8eca"),
    "ev-charging": ("ev charging", "electric vehicle charging", "\u96fb\u52d5\u8eca\u5145\u96fb"),
    "home-energy": ("home energy", "vehicle-to-home", "v2h", "home battery", "\u5bb6\u7528\u5132\u80fd"),
    "policy": ("policy", "regulation", "government", "senate", "subsidy", "tariff", "nhtsa", "\u653f\u7b56", "\u6cd5\u898f", "\u653f\u5e9c"),
    "smart-mobility": ("autonomous", "robotaxi", "self-driving", "driverless", "mobility", "lidar", "fleet", "\u81ea\u99d5", "\u7121\u4eba\u99d5\u99db", "\u667a\u6167\u79fb\u52d5"),
